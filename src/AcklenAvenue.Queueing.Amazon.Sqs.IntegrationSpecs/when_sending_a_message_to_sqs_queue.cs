        ...
        It should_be_able_to_get_the_message_from_the_queue = () =>
                                                              {
                                                                  ...
                                                                  messsageSended.Messages[0].Body.ShouldEqual(
                                                                      JsonConvert.SerializeObject(_fakeMessage));
                                                                  messsageSended.Messages[0].MessageAttributes["Type"]
                                                                      .StringValue.ShouldEqual(
                                                                          typeof (FakeMessage).FullName);
                                                              };
